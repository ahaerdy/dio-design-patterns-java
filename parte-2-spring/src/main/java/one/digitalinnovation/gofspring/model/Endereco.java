 ...
 * O Spring usa @Entity para mapear esta classe como uma tabela
 * no banco de dados automaticamente — sem SQL manual.
 * O CEP é usado como chave primária (@Id), pois identifica
 * unicamente cada endereço.
 */
@Entity
